...
DNL
platform:/resource/ProjetoIC/src/Models/dnl/SistemaP.dnl
635386738
 Do not remove or modify this comment!  It is required for file identification! */
package Models.java;
...
public class SistemaP extends AtomicModelImpl implements PhaseBased,
    StateVariableBased {
    private static final long serialVersionUID = 1L;

    //ID:SVAR:0
    private static final int ID_CONTADORP = 0;

    // Declare state variables
    private PropertyChangeSupport propertyChangeSupport =
        new PropertyChangeSupport(this);
    protected Contador ContadorP;
    ...
    public SistemaP(String name) {
        this(name, null);
    }

    public SistemaP(String name, Simulator simulator) {
    ...
    public static void main(String[] args) {
        ...
        SistemaP model = new SistemaP();
        model.options = options;

        if (options.isDisableViewer()) { // Command line output only
            Simulation sim =
                new com.ms4systems.devs.core.simulation.impl.SimulationImpl("SistemaP Simulation",
                    model, options);
    ...
    // Getter/setter for ContadorP
    public void setContadorP(Contador ContadorP) {
        propertyChangeSupport.firePropertyChange("ContadorP", this.ContadorP,
            this.ContadorP = ContadorP);
    }

    public Contador getContadorP() {
        return this.ContadorP;
    }

    // End getter/setter for ContadorP

    // State variables
    public String[] getStateVariableNames() {
        return new String[] { "ContadorP" };
    }

    public Object[] getStateVariableValues() {
        return new Object[] { ContadorP };
    }
    ...
    protected static File getModelsDirectory() {
        ...
        File dir;
        try {
            dirUri = SistemaP.class.getResource(".").toURI();
            dir = new File(dirUri);
        } catch (URISyntaxException e) {
            e.printStackTrace();
            throw new RuntimeException(
                "Could not find Models directory. Invalid model URL: " +
                SistemaP.class.getResource(".").toString());
        }
    ...
    public String[] getPhaseNames() {
        return new String[] { "Enviar", "Esperar", "Receber" };
    }
}
